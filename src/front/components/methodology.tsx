...
export default function Methodology() {
  return (
    <section
      id="methodology"
      className="min-h-[100svh] pb-24 bg-foreground text-background"
    >
      <div className="container mx-auto flex flex-col">
        ...
        <div className="text-center text-2xl md:text-3xl font-semibold mt-24">
          Votre solution en 3 étapes
        </div>
